...
main() {
	int t;
	cout<<"Press 1 to Run Program ";cout<<"\n";
	cout<<"Press 0 to Exit ";cout<<"\n";
	cout<<"Your Choice : ";cin>>t;
...
/* -----------------------------------------------------------------------*/
	...
	system("cls");
	int NUMPAT, NUMIN,NUMHID;
	
		//Get Data
	/* -----------------------------------------------------------------------*/
	cout<<"Number Pattern(s) = "; cin>>NUMPAT;cout<<"\n";
	cout<<"Number Input(s) = "; cin>>NUMIN;cout<<"\n";
	cout<<"Number Hidden(s) = "; cin>>NUMHID;cout<<"\n";
	/* -----------------------------------------------------------------------*/
...
/* ----------------------------------------------------------------------------------------------*/
	...
	cout<<"Press 1 to Run Program Again";cout<<"\n";
	cout<<"Press 0 to Exit ";cout<<"\n";
	cin>>t;
